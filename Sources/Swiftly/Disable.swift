...
struct Disable: SwiftlyCommand {
    public static var configuration = CommandConfiguration(
        abstract: "Disable swiftly."
    )

    @Argument(help: ArgumentHelp(
        "Disables swiftly, allowing the system default toolchain to be used.",
        discussion: """

        Disables swiftly until swiftly is enabled again with:
